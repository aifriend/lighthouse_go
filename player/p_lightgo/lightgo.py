...
from player.p_lightgo.bot import Bot
from player.p_lightgo.interface import Interface
from player.p_lightgo.utils import Utils
...
class LightGo(Bot):
    ...
    def __init__(self, init_state):
        super(LightGo, self).__init__(init_state)
        self.lh_dist_maps = {
