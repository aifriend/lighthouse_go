...
class ArdRi(Tafl):
    def __init__(self):
        self.size = 7
        self.board = self.expandeighth(self.size, [[0, 0, 1], [3, 3, 2]])
        self.pieces = self.expandeighth(self.size,
...
class Tawlbwrdd(Tafl):
    def __init__(self):
        ...
        self.pieces = self.expandeighth(self.size,
                                        [[4, 0, -1], [5, 0, -1], [4, 1, -1], [5, 2, -1], [5, 3, 1], [5, 4, 1],
                                         [4, 4, 1], [5, 5, 2]])
...
class Hnefatafl(Tafl):
    def __init__(self):
        ...
        self.board = self.expandeighth(self.size, [[0, 0, 1], [5, 5, 2]])
        self.pieces = self.expandeighth(self.size,
                                        [[3, 0, -1], [4, 0, -1], [5, 0, -1], [5, 1, -1], [5, 3, 1], [5, 4, 1],
                                         [4, 4, 1], [5, 5, 2]])
...
class AleaEvangelii(Tafl):
    def __init__(self):
        ...
        self.pieces = self.expandeighth(self.size,
                                        [[2, 0, -1], [5, 0, -1], [5, 2, -1], [7, 3, -1], [9, 3, -1], [6, 4, -1],
                                         [5, 5, -1], [8, 4, 1], [9, 6, 1], [8, 7, 1], [9, 8, 1], [9, 9, 2]])
