...
sys.path.append('..')
from examples.rts.src.Board import Board
from examples.rts.src.config import NUM_ENCODERS, NUM_ACTS, P_NAME_IDX, A_TYPE_IDX, TIME_IDX, FPS
...
def display(board):
    ...
    :return: /
    """
    from examples.rts.visualization.rts_pygame import init_visuals, update_graphics
