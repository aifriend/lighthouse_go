...
sys.path.append('../..')
from examples.rts.src.config import USE_TF_CPU, SHOW_TENSORFLOW_GPU
...
class RTSNNet:
    def __init__(self, game, encoder):
        ...
        x_image = Reshape((self.board_x, self.board_y, num_encoders))(
        ...
        s_fc1 = Dropout(CONFIG.nnet_args.dropout)(Activation('relu')(
            BatchNormalization(axis=1)(Dense(256, use_bias=False)(h_conv4_flat))))  # batch_size x 1024
        s_fc2 = Dropout(CONFIG.nnet_args.dropout)(
            Activation('relu')(BatchNormalization(axis=1)(Dense(128, use_bias=False)(s_fc1))))  # batch_size x 1024
